...
function ActivityCard({ activity }) {
  return (
    <div className="bg-card border border-white/10 rounded-2xl px-4 py-3 mb-2">
...
export default function HomeView() {
  ...
  // Handle Supabase user + display name
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-full min-h-full">
      ...
      <div className="flex flex-col px-4 pb-8">
        ...
        {/* Strava section */}
        {callbackError && (
          <p className="text-white text-sm text-center mb-4">{callbackError}</p>
        )}

        {!connected ? (
          <div className="flex flex-col items-center bg-card border border-white/10 rounded-2xl px-6 py-8">
          ...
          <>
            ...
            {loadingActivities ? (
              ...
              <div className="bg-card border border-white/10 rounded-2xl px-4 py-6 text-center">
